 ...
 * - Special Note: Subject to special financial supervision (e.g., capital adequacy check)
 */
contract Cathay2882 is ERC20 {
    ...
    constructor(address priceFeed) ERC20("Cathay Financial Token", "Cathay") {
